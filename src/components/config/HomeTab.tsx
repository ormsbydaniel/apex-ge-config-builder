  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold text-primary">Configuration Home</h1>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button size="sm" variant="outline" onClick={() => setIsEditingLogo(true)}>
            ...
            {isEditingLogo ? (
              ...
              <div className="flex justify-center p-4 border rounded-lg bg-gray-50">
                {config.layout.navigation.logo ? (
                  ...
                  <div className="text-sm text-gray-500 italic">No logo set</div>
                )}
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            ...
            {isEditingTitle ? (
              ...
              <div className="p-3 border rounded bg-gray-50">
                <span className="font-medium text-lg">{config.layout.navigation.title}</span>
              </div>
            )}
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="p-3 border rounded">
              ...
              <div className="text-sm text-gray-600">Interface Groups</div>
            </div>
            <div className="p-3 border rounded">
              <div className="text-2xl font-bold text-primary">{config.exclusivitySets.length}</div>
              <div className="text-sm text-gray-600">Exclusivity Sets</div>
            </div>
            <div className="p-3 border rounded">
