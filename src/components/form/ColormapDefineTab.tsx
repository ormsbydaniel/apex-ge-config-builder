...
const ColormapDefineTab = ({
  ...
  const handleEdit = (index: number) => {
    ...
    onSetCurrentColormap({ ...localColormaps[index] });
  };
  ...
  const handleSave = () => {
    ...
    const updatedColormaps = [...localColormaps];
  ...
  const handleRemove = (index: number) => {
    const updatedColormaps = localColormaps.filter((_, i) => i !== index);
    onSetLocalColormaps(updatedColormaps);
    toast({
      title: "Colormap Removed",
      description: `Colormap has been removed.`,
    });
  };
      ...
      {localColormaps.length > 0 && (
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {localColormaps.map((colormap, index) => (
...
export default ColormapDefineTab;