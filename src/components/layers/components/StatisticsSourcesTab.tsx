  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold">Statistics Sources</h3>
        <Button
          variant="outline"
          size="sm"
      ...
      {hasStatistics ? (
        <DataSourceDisplay
          source={statsOnlySource}
          services={services}
          onRemoveDataSource={(statsIndex) => onRemove(layerIndex, statsIndex)}
          onEditDataSource={(statsIndex) => onEdit(layerIndex, statsIndex)}
        />
      ) : (
