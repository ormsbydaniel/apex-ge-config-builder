...
const Preview = () => {
  ...
  return (
    <>
      ...
      <header className="absolute top-[3px] left-1/2 -translate-x-1/2 translate-x-[10%] translate-y-[150%] z-50 border rounded-lg bg-card/95 backdrop-blur-sm shadow-lg px-3 py-1">
