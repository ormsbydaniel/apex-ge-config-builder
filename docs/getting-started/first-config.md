...
!!! note "Coming soon"
    Detailed step-by-step content for this page is in progress. The shape
    of the workflow is:

    1. **Home** — set the project title and version.
    2. **Settings → Interface Groups** — create one or two top-level groups.
    3. **Services** — add at least one service (e.g. a WMTS endpoint).
...
For each numbered step the corresponding chapter in this guide gives the
detail. Start with the [Home tab](../configuration/home.md).
