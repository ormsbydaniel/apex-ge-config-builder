---
title: 4-3. Categories for a WMS layer
---
# 4-3. Categories for a WMS layer
...
1. On the **Layers** tab, edit the *World Cover* layer card you created in
   [Add a WMS layer directly](../02-getting-started/10-wms-service.md).
...
3. Toggle **Use data values** on. An additional column appears for the raw
   pixel values.
4. Add your first category — for example, colour `green`, label `Tree cover`,
   value `10`.
5. Add another couple of categories for World Cover. Use the World Cover
   preview from the Explorer along with your OS colour picker to grab the
   right colours.
